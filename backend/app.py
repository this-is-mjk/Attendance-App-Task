...
# Add Student
# Path is allowed for any one Logged in but request will be rejected if not admin
...
# Soul of the program
# Check_face it takes two BytesIO image file to check if the images have same face
